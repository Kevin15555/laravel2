            ...
            <div class="accordion-item">
                ...
                <div id="collapseFinance" class="accordion-collapse collapse">
                    <div class="accordion-body">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('pettycash.index') ? 'active' : '' }}" href="{{ route('pettycash.index') }}">
                            ...
                            <li class="nav-item"><a class="nav-link {{ request()->routeIs('coa.master') ? 'active' : '' }}" href="{{ route('coa.master') }}"><i class="bi bi-coin me-2"></i> COA Master</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ url('/slip-gaji') }}"><i class="bi bi-piggy-bank me-2"></i> Slip Gaji</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('pajak.index') }}"><i class="bi bi-percent me-2"></i> Pajak</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('bpjs.index') }}"><i class="bi bi-shield-check me-2"></i> BPJS</a></li>
                        </ul>
                    </div>
                </div>
            </div>
